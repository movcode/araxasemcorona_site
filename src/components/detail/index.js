...
export default props => {
    ...
    return (
        <div>
            <BoxShare active={showShare ? 1 : 0}>
                <Close>
                    <div onClick={() => _showShare(false)}  >
                ...
                <BoxButtonsShare className="d-flex flex-column justify-content-center align-items-center" >
                    ...
                    <Href href={`https://api.whatsapp.com/send?text=${window.location.href}`}
                        ...
                        className="btn btn-outline-light">
                        <img width="24" src="/img/whatsapp.png" style={{ marginRight: '10px' }} alt="" />
                                ...
                                <div className="col-7 col-md-9">
                                    <HeaderContent>
                                        ...
                                        <Row className="col-md-4">
                                            ...
                                            <Itens >
                                                <ButtonShare onClick={() => _showShare(true)}>
